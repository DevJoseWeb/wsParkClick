 ...
 */
@Entity
@Table(name = "v_horario_mes", schema = "e_base")
@Immutable
public class HorarioMes implements SesaModel {
    private static final long serialVersionUID = 240612380984034291L;
    ...
    public boolean equals(Object obj) {
        ...
        final HorarioMes other = (HorarioMes) obj;
    ...
    public String toString() {
        return "br.gov.ce.saude.ponto.entidade.HorarioMes[ id=" + id + " ]";
    } 
}
