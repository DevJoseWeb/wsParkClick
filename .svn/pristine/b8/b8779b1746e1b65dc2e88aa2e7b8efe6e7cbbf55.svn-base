...
public class HorasTrabalhadaVO implements Serializable {
    ...
    public HorasTrabalhadaVO(String nome, String funcao, String sigla, String data, Double diaSemana, String horario, Date batida1, Date batida2, String tipoPlantao, String hora, String plantao) {
        this.nome = nome;
        this.funcao = funcao;
        this.sigla = sigla;
        this.data = data;
